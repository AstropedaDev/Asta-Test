...
const { smd, prefix, sleep, send, Config } = require("../lib/");
  ...
  async (_0x28198a, _0xbd1cc1) => {
    let _0x44d1f1 = [
      ...
      "`Me: Yo this is` @" +
        ...
        ",`Please Connect me to my lil bro, Suhail Tech`",
      "`User Authorised.`",
      "`Calling Suhail Tech`  `At +923184474176`",
      "`Private  Call Connected...`",
      "`Me: Hello Sir, Please Ban This Whatsapp Account.`",
      "`Suhail: May I Know Who Is This?`",
      "`Me: Yo Brah, I Am` @" + _0x28198a.senderName,
      "`Suhail: OMG!!! Long time no see, Wassup Brother...\nI'll Make Sure That Guy Account Will Get Blocked Within 24Hrs.`",
      "`Me: Thanks, See You Later Brah.`",
      "`Suhail: Please Don't Thank Brah, Whatsapp Is Our's. Just Gimme A Call When You Become Free.`",
      "`Me: Is There Any Issue/Emergency???`",
      "`Suhail: Yes Sur, There Is A Bug In Whatsapp v69.6.9.\nI Am Not Able To Fix It. If Possible, Please Help Fix The Bug.`",
